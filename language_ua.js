...
Наприклад, 01.12.2024. Або час в форматі 18:00 щоб відфільтрувати результати`,
    seat: `Будь ласка, оберіть місце 👇:`,
    geolocation: 'Будь ласка, надішліть свою геопозицію:',
    sendGeo: 'Або поділіться розташуванням за допомогою кнопки «надіслати»:',
    taxiOnTheWay: 'Додайте напрямок руху або залиште довільним',
    ...
    rules: `Замовлення авто 1000 гривень (включає подачу та 1 годину роботи, додаткова година роботи плюс 500 гривень)`,
