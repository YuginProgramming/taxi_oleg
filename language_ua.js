...
const phrases = {
    botInformation: `
Вас вітає чат-бот пасажирських перевезень!

Ми пропонуємо:

Поїздки по Києву та Україні в комфортабельних 6-8 місних Mercedes (останні моделі).
 Міжміські та міжнародні маршрути. Обслуговування цілодобово.
`,
